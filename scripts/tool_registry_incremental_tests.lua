        ...
        settings = {
            keyring = {
                tool_calling = {
                    ...
                    retry_budget_max = 0,
                    retry_total_cap = 2,
                    agent_file_list_max_per_turn = 2,
                    agent_file_list_default_limit = 12,
                    agent_file_list_hard_limit = 64,
                    agent_file_read_max_per_turn = 4,
                    agent_file_read_default_max_chars = 3000,
                    agent_file_read_hard_max_chars = 12000,
                    agent_file_read_lines_max_per_turn = 4,
                    agent_file_read_lines_default_max_lines = 220,
                    agent_file_read_lines_hard_max_lines = 1200,
                    agent_file_search_max_per_turn = 4,
                    agent_file_search_default_max_hits = 20,
                    agent_file_search_hard_max_hits = 200,
                    agent_file_multi_search_max_per_turn = 3,
                    agent_file_multi_search_default_max_hits = 30,
                    agent_file_multi_search_hard_max_hits = 400,
                    agent_file_multi_search_default_max_files = 24,
                    agent_file_multi_search_hard_max_files = 200,
                    agent_file_multi_search_default_per_file_hits = 5,
                    agent_file_multi_search_hard_per_file_hits = 20,
                    agent_file_context_max_chars = 1600,
                }
            }
        }
    }
