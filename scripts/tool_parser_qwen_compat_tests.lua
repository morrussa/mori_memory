...
assert(file_call ~= nil, "read_agent_file json call should parse")
...
assert(lines_call ~= nil, "read_agent_file_lines json call should parse")
...
assert(multi_search ~= nil, "search_agent_files json call should parse")
